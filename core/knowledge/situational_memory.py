...
_EXTRACTION_SYSTEM = (
    ...
    "  You will receive two sections: 'User said:' and 'Context only:'.\n"
    "  Extract facts ONLY from the 'User said:' section.\n"
    "  The 'Context only:' section contains Jarvis's response. "
    "It is provided solely to help resolve pronouns and references.\n"
    "  Jarvis's response is NEVER an authoritative source of facts about the user.\n"
    "  If a fact appears only in the 'Context only:' section and not in "
    "'User said:', do NOT extract it.\n"
    "  User-originated content is the ONLY authoritative source for user memory.\n"
